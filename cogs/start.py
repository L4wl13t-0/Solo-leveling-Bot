...
class Start(commands.Cog, name = 'start'):
    ...
    async def start(self, ctx):
        ...
        embed.add_field(name = 'HOW TO FARM?', value = ':white_small_square: To farm **EXP** and **COINS** use :dagger: `hunt`, where you will have to complete the hunt. Do not forget to use :syringe: `life` to regenerate your life, you can buy more in the store.\n:white_small_square: To farm items you must go `hunt`, `adventure` or `dungeon` and find treasures.', inline = False)
